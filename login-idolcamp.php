...
$_SESSION['WPOA']['PROVIDER'] = 'Idolcamp';
define('HTTP_UTIL', get_option('wpoa_http_util'));
define('CLIENT_ENABLED', get_option('wpoa_idolcamp_api_enabled'));
define('CLIENT_ID', get_option('wpoa_idolcamp_api_id'));
define('CLIENT_SECRET', get_option('wpoa_idolcamp_api_secret'));
define('REDIRECT_URI', rtrim(site_url(), '/') . '/');
define('URL_AUTH', "https://idolcamp.idol.io/oauth/authorize?");
define('URL_TOKEN', "https://idolcamp.idol.io/oauth/token?");
define('URL_USER', "https://idolcamp.idol.io/api/v1/me?");
